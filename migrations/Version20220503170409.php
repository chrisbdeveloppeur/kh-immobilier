 ...
 */
final class Version20220503170409 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etat_des_lieux DROP FOREIGN KEY FK_F721031261220EA6');
        $this->addSql('ALTER TABLE etat_des_lieux ADD CONSTRAINT FK_F721031261220EA6 FOREIGN KEY (creator_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user ADD etat_des_lieux_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6491EA7F144 FOREIGN KEY (etat_des_lieux_id) REFERENCES etat_des_lieux (id) ON UPDATE NO ACTION ON DELETE CASCADE');
