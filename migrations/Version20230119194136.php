 ...
 */
final class Version20230119194136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bien_immo (id INT AUTO_INCREMENT NOT NULL, copropriete_id INT DEFAULT NULL, user_id INT DEFAULT NULL, etat_des_lieux_id INT DEFAULT NULL, building VARCHAR(255) DEFAULT NULL, street VARCHAR(255) NOT NULL, cp VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, loyer_hc INT NOT NULL, charges INT NOT NULL, first_day VARCHAR(255) DEFAULT NULL, last_day VARCHAR(255) DEFAULT NULL, month VARCHAR(255) DEFAULT NULL, echeance INT DEFAULT NULL, free TINYINT(1) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, superficie DOUBLE PRECISION DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_174DAB76B07769E (copropriete_id), INDEX IDX_174DAB7A76ED395 (user_id), INDEX IDX_174DAB71EA7F144 (etat_des_lieux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
