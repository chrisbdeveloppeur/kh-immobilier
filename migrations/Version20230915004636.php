 ...
 */
final class Version20230915004636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE financement (id INT AUTO_INCREMENT NOT NULL, bien_immo_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, date_investissement DATE DEFAULT NULL, montant DOUBLE PRECISION DEFAULT NULL, taux DOUBLE PRECISION DEFAULT NULL, mensualites DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_59895F568AEFB514 (bien_immo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE frais (id INT AUTO_INCREMENT NOT NULL, tag_id INT DEFAULT NULL, bien_immo_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantity INT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, mensuel TINYINT(1) NOT NULL, benefice TINYINT(1) NOT NULL, INDEX IDX_25404C98BAD26311 (tag_id), INDEX IDX_25404C988AEFB514 (bien_immo_id), INDEX IDX_25404C98A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT DEFAULT NULL, image_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, signature_file_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649A4AEAFEA (entreprise_id), UNIQUE INDEX UNIQ_8D93D6493DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
